...
from defi_repertoire.strategies.base import AddressOption
...
async def test_curve_options_gnosis():
    ...
    assert opts2.token_out_address == [
        AddressOption(
            address="0x4ECaBa5870353805a9F068101A40E0f32ed605C6", label="USDT"
        ),
        AddressOption(
            address="0xDDAfbb505ad214D7b80b1f830fcCc89B60fb7A83", label="USDC"
        ),
        AddressOption(
            address="0xa555d5344f6FB6c65da19e403Cb4c1eC4a1a5Ee3", label="BREAD"
        ),
        AddressOption(
            address="0xaBEf652195F98A91E490f047A5006B71c85f058d", label="crvUSD"
        ),
        AddressOption(
            address="0xaf204776c7245bF4147c2612BF6e5972Ee483701", label="sDAI"
        ),
    ]
